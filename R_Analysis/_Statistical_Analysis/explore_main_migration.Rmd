...
mean(merged_data_tribe$n_unique_FIPS_t1)
...
mean(filter(data_long, time == "time 1")$n_unique_FIPS)
mean(filter(data_long, time == "time 2")$n_unique_FIPS)
median(filter(data_long, time == "time 1")$n_unique_FIPS)
median(filter(data_long, time == "time 2")$n_unique_FIPS)
