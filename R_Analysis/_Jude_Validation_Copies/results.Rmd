...
## Precipitation
Oregon State University's PRISM Climate Group calcualtes average precipitation (inches) over 30-year time periods. We use data that is calculated between 1981 and 2010.
...
## Federal Lands
The U.S. Geological Survey's Protected Lands Database of the U.S. (PAD-US) is a spatial inventory of all formally protected lands. We select only lands protected by the Federal Government (e.g. national parks, national forests, etc.). We calculate total proportion of a CCE's land area which is designated as any type of federally protected area.
