...
We use the Palmer Drought Severity Index (PDSI) to assess exposure to drought. We incorporate drought conditions in the continental US using weekly gridded (4km resolution) Palmer Drought Severity Index (PDSI) data from gridMET (Abatzoglou, 2013).  The PDSI is unitless and ranges from -10 (extreme drought) to +10 (extreme wet).  First, we calculate the median PDSI of all grid cells within the county boundary for each week from 1980-2017.  We then calculate the  mean PDSI over all weeks 1980-2017.  
